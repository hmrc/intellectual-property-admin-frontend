...
class Navigator @Inject() () {
  private val normalRoutes: Page => UserAnswers => Call = {
    ...
    case RestrictedHandlingPage                                 =>
      ua => routes.PermissionToDestroySmallConsignmentsController.onPageLoad(NormalMode, ua.id)
    ...
    case CompanyApplyingUkAddressPage                           =>
      ua => routes.CompanyApplyingIsRightsHolderController.onPageLoad(NormalMode, ua.id)
    case CompanyApplyingInternationalAddressPage                =>
      ua => routes.CompanyApplyingIsRightsHolderController.onPageLoad(NormalMode, ua.id)
    ...
    case RepresentativeContactUkAddressPage                     =>
      ua => routes.IsRepresentativeContactLegalContactController.onPageLoad(NormalMode, ua.id)
    case RepresentativeContactInternationalAddressPage          =>
      ua => routes.IsRepresentativeContactLegalContactController.onPageLoad(NormalMode, ua.id)
    // Legal contact section
    case IsRepresentativeContactLegalContactPage                => isRepresentativeContactLegalContactRoute
    case ApplicantLegalContactPage                              =>
      ua => routes.IsApplicantLegalContactUkBasedController.onPageLoad(NormalMode, ua.id)
    case IsApplicantLegalContactUkBasedPage                     => isApplicantLegalContactUkBasedRoute
    case ApplicantLegalContactUkAddressPage                     =>
      ua => routes.AddAnotherLegalContactController.onPageLoad(NormalMode, ua.id)
    case ApplicantLegalContactInternationalAddressPage          =>
      ua => routes.AddAnotherLegalContactController.onPageLoad(NormalMode, ua.id)
    // Secondary Legal contact section
    case AddAnotherLegalContactPage                             => ua => addAnotherLegalContactRoute(ua)
    case WhoIsSecondaryLegalContactPage                         =>
      ua => routes.IsApplicantSecondaryLegalContactUkBasedController.onPageLoad(NormalMode, ua.id)
    case IsApplicantSecondaryLegalContactUkBasedPage            => isApplicantSecondaryLegalContactUkBasedRoute
    case ApplicantSecondaryLegalContactUkAddressPage            =>
      ua => routes.SelectTechnicalContactController.onPageLoad(NormalMode, ua.id)
    case ApplicantSecondaryLegalContactInternationalAddressPage =>
      ua => routes.SelectTechnicalContactController.onPageLoad(NormalMode, ua.id)
    ...
    case TechnicalContactUkAddressPage                          =>
      ua => routes.AddAnotherTechnicalContactController.onPageLoad(NormalMode, ua.id)
    case TechnicalContactInternationalAddressPage               =>
      ua => routes.AddAnotherTechnicalContactController.onPageLoad(NormalMode, ua.id)
    ...
    case WhoIsSecondaryTechnicalContactPage                     =>
      ua => routes.IsSecondaryTechnicalContactUkBasedController.onPageLoad(NormalMode, ua.id)
    ...
    case IpRightsRegistrationNumberPage(id)                     =>
      ua => routes.IpRightsRegistrationEndController.onPageLoad(NormalMode, id, ua.id)
    case IpRightsSupplementaryProtectionCertificateTypePage(id) =>
      ua => routes.IpRightsRegistrationNumberController.onPageLoad(NormalMode, id, ua.id)
    case IpRightsRegistrationEndPage(id)                        => ipRightsRegistrationEndRoute(id)
    case IpRightsNiceClassPage(iprIndex, _)                     =>
      ua => routes.IpRightsAddNiceClassController.onPageLoad(NormalMode, iprIndex, ua.id)
    case IpRightsAddNiceClassPage(iprIndex)                     => addNiceClassRoute(NormalMode, iprIndex)
    case IpRightsDescriptionPage(iprIndex)                      =>
      ua => routes.CheckIprDetailsController.onPageLoad(NormalMode, iprIndex, ua.id)
    case IpRightsDescriptionWithBrandPage(id)                   =>
      ua => routes.IpRightsNiceClassController.onPageLoad(NormalMode, id, 0, ua.id)
  ...
  private def additionalInfoProvidedRoute(mode: Mode)(answers: UserAnswers): Call =
    (mode, answers.get(AdditionalInfoProvidedPage), answers.get(RestrictedHandlingPage)) match {
      ...
      case (NormalMode, Some(false), _)  =>
        routes.PermissionToDestroySmallConsignmentsController.onPageLoad(mode, answers.id)
  ...
  private def isApplicantRightsHolder(answers: UserAnswers): Call =
    answers.get(CompanyApplyingIsRightsHolderPage) match {
      case Some(_) => routes.RepresentativeContactController.onPageLoad(NormalMode, answers.id)
      case None    => routes.SessionExpiredController.onPageLoad
    }

  private def selectTechnicalContactRoute(userAnswers: UserAnswers): Call =
    userAnswers.get(SelectTechnicalContactPage) match {
      case Some(ContactOptions.SomeoneElse) =>
        routes.WhoIsTechnicalContactController.onPageLoad(NormalMode, userAnswers.id)
      case Some(_)                          => routes.AddAnotherTechnicalContactController.onPageLoad(NormalMode, userAnswers.id)
      case _                                => routes.SessionExpiredController.onPageLoad
    }

  private def selectOtherTechnicalContactRoute(userAnswers: UserAnswers): Call =
    userAnswers.get(SelectOtherTechnicalContactPage) match {
      case Some(ContactOptions.SomeoneElse) =>
        routes.WhoIsSecondaryTechnicalContactController.onPageLoad(NormalMode, userAnswers.id)
  ...
  private def isRepresentativeContactLegalContactRoute(userAnswers: UserAnswers): Call =
    userAnswers.get(IsRepresentativeContactLegalContactPage) match {
  ...
  private def isRepresentativeContactUkBasedRoute(answers: UserAnswers): Call =
    answers.get(IsRepresentativeContactUkBasedPage) match {
  ...
  private def isCompanyApplyingUkBasedRoute(answers: UserAnswers): Call =
    answers.get(IsCompanyApplyingUkBasedPage) match {
  ...
  private def isApplicantLegalContactUkBasedRoute(answers: UserAnswers): Call =
    answers.get(IsApplicantLegalContactUkBasedPage) match {
  ...
  private def addAnotherLegalContactRoute(userAnswers: UserAnswers): Call =
    userAnswers.get(AddAnotherLegalContactPage) match {
  ...
  private def isApplicantSecondaryLegalContactUkBasedRoute(answers: UserAnswers): Call =
    answers.get(IsApplicantSecondaryLegalContactUkBasedPage) match {
      case Some(true)  => routes.ApplicantSecondaryLegalContactUkAddressController.onPageLoad(NormalMode, answers.id)
      case Some(false) =>
        routes.ApplicantSecondaryLegalContactInternationalAddressController.onPageLoad(NormalMode, answers.id)
      case None        => routes.SessionExpiredController.onPageLoad
    }
  private def isTechnicalContactUkBasedRoute(answers: UserAnswers): Call               =
    answers.get(IsTechnicalContactUkBasedPage) match {
  ...
  private def addAnotherTechnicalContactRoute(userAnswers: UserAnswers): Call =
    userAnswers.get(AddAnotherTechnicalContactPage) match {
  ...
  private def isSecondaryTechnicalContactUkBasedRoute(answers: UserAnswers): Call =
    answers.get(IsSecondaryTechnicalContactUkBasedPage) match {
      case Some(true)  => routes.SecondaryTechnicalContactUkAddressController.onPageLoad(NormalMode, answers.id)
      case Some(false) =>
        routes.SecondaryTechnicalContactInternationalAddressController.onPageLoad(NormalMode, answers.id)
      case None        => routes.SessionExpiredController.onPageLoad
    }
  ...
  private def ipRightsRegistrationEndRoute(iprIndex: Int)(answers: UserAnswers): Call =
    answers.get(IpRightsTypePage(iprIndex)) match {
      case Some(IpRightsType.Trademark) =>
        routes.IpRightsDescriptionWithBrandController.onPageLoad(NormalMode, iprIndex, answers.id)
  ...
  private val checkRouteMap: (Page, Mode) => UserAnswers => Call = {
    ...
    case (IpRightsSupplementaryProtectionCertificateTypePage(index), _mode) =>
      ipRightsSupplementaryProtectionCertificateTypeCheckRoute(_mode, index)
    case (IpRightsNiceClassPage(iprIndex, _), _mode)                        =>
      ua => routes.IpRightsAddNiceClassController.onPageLoad(_mode, iprIndex, ua.id)
  ...
  private def isCompanyApplyingUkBasedCheckRoute(ua: UserAnswers): Call =
    (
      ua.get(IsCompanyApplyingUkBasedPage),
      ua.get(CompanyApplyingUkAddressPage),
      ua.get(CompanyApplyingInternationalAddressPage)
    ) match {
  ...
  private def isRepresentativeContactUkBasedCheckRoute(ua: UserAnswers): Call =
    (
      ua.get(IsRepresentativeContactUkBasedPage),
      ua.get(RepresentativeContactUkAddressPage),
      ua.get(RepresentativeContactInternationalAddressPage)
    ) match {
      case (Some(true), None, _)  => routes.RepresentativeContactUkAddressController.onPageLoad(CheckMode, ua.id)
      case (Some(false), _, None) =>
        routes.RepresentativeContactInternationalAddressController.onPageLoad(CheckMode, ua.id)
      case _                      => routes.CheckYourAnswersController.onPageLoad(ua.id)
    }
  ...
  private def isApplicantLegalContactUkBasedCheckRoute(ua: UserAnswers): Call =
    (
      ua.get(IsApplicantLegalContactUkBasedPage),
      ua.get(ApplicantLegalContactUkAddressPage),
      ua.get(ApplicantLegalContactInternationalAddressPage)
    ) match {
      case (Some(true), None, _)  => routes.ApplicantLegalContactUkAddressController.onPageLoad(CheckMode, ua.id)
      case (Some(false), _, None) =>
        routes.ApplicantLegalContactInternationalAddressController.onPageLoad(CheckMode, ua.id)
      case _                      => routes.CheckYourAnswersController.onPageLoad(ua.id)
    }
  ...
  private def isApplicantSecondaryLegalContactUkBasedCheckRoute(ua: UserAnswers): Call =
    (
      ua.get(IsApplicantSecondaryLegalContactUkBasedPage),
      ua.get(ApplicantSecondaryLegalContactUkAddressPage),
      ua.get(ApplicantSecondaryLegalContactInternationalAddressPage)
    ) match {
      case (Some(true), None, _)  =>
        routes.ApplicantSecondaryLegalContactUkAddressController.onPageLoad(CheckMode, ua.id)
      case (Some(false), _, None) =>
        routes.ApplicantSecondaryLegalContactInternationalAddressController.onPageLoad(CheckMode, ua.id)
      case _                      => routes.CheckYourAnswersController.onPageLoad(ua.id)
    }
  ...
  private def applicantLegalContactCheckRoute(ua: UserAnswers): Call =
    ua.get(IsApplicantLegalContactUkBasedPage) match {
      case Some(_) => routes.CheckYourAnswersController.onPageLoad(ua.id)
  ...
  private def isTechnicalContactUkBasedCheckRoute(ua: UserAnswers): Call =
    (
      ua.get(IsTechnicalContactUkBasedPage),
      ua.get(TechnicalContactUkAddressPage),
      ua.get(TechnicalContactInternationalAddressPage)
    ) match {
  ...
  private def isSecondaryTechnicalContactUkBasedCheckRoute(ua: UserAnswers): Call =
    (
      ua.get(IsSecondaryTechnicalContactUkBasedPage),
      ua.get(SecondaryTechnicalContactUkAddressPage),
      ua.get(SecondaryTechnicalContactInternationalAddressPage)
    ) match {
      case (Some(true), None, _)  => routes.SecondaryTechnicalContactUkAddressController.onPageLoad(CheckMode, ua.id)
      case (Some(false), _, None) =>
        routes.SecondaryTechnicalContactInternationalAddressController.onPageLoad(CheckMode, ua.id)
      case _                      => routes.CheckYourAnswersController.onPageLoad(ua.id)
    }

  private def ipRightsSupplementaryProtectionCertificateTypeCheckRoute(mode: Mode, index: Int)(
    ua: UserAnswers
  ): Call = {
  ...
  protected def mainPageStatuses(answers: UserAnswers): Seq[PageStatus[_]] =
    Seq(
      PageStatus(
        ApplicationReceiptDatePage,
        answers,
        routes.ApplicationReceiptDateController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(CompanyApplyingPage, answers, routes.CompanyApplyingController.onPageLoad(NormalMode, answers.id)),
      PageStatus(
        IsCompanyApplyingUkBasedPage,
        answers,
        routes.IsCompanyApplyingUkBasedController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        CompanyApplyingUkAddressPage,
        answers,
        routes.CompanyApplyingUkAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        CompanyApplyingInternationalAddressPage,
        answers,
        routes.CompanyApplyingInternationalAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        CompanyApplyingIsRightsHolderPage,
        answers,
        routes.CompanyApplyingIsRightsHolderController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        RepresentativeDetailsPage,
        answers,
        routes.RepresentativeContactController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        EvidenceOfPowerToActPage,
        answers,
        routes.EvidenceOfPowerToActController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        IsRepresentativeContactUkBasedPage,
        answers,
        routes.IsRepresentativeContactUkBasedController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        RepresentativeContactUkAddressPage,
        answers,
        routes.RepresentativeContactUkAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        RepresentativeContactInternationalAddressPage,
        answers,
        routes.RepresentativeContactInternationalAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        IsRepresentativeContactLegalContactPage,
        answers,
        routes.IsRepresentativeContactLegalContactController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        ApplicantLegalContactPage,
        answers,
        routes.ApplicantLegalContactController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        IsApplicantLegalContactUkBasedPage,
        answers,
        routes.IsApplicantLegalContactUkBasedController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        ApplicantLegalContactUkAddressPage,
        answers,
        routes.ApplicantLegalContactUkAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        ApplicantLegalContactInternationalAddressPage,
        answers,
        routes.ApplicantLegalContactInternationalAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        AddAnotherLegalContactPage,
        answers,
        routes.AddAnotherLegalContactController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        WhoIsSecondaryLegalContactPage,
        answers,
        routes.WhoIsSecondaryLegalContactController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        IsApplicantSecondaryLegalContactUkBasedPage,
        answers,
        routes.IsApplicantSecondaryLegalContactUkBasedController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        ApplicantSecondaryLegalContactUkAddressPage,
        answers,
        routes.ApplicantSecondaryLegalContactUkAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        ApplicantSecondaryLegalContactInternationalAddressPage,
        answers,
        routes.ApplicantSecondaryLegalContactInternationalAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        SelectTechnicalContactPage,
        answers,
        routes.SelectTechnicalContactController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        WhoIsTechnicalContactPage,
        answers,
        routes.WhoIsTechnicalContactController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        IsTechnicalContactUkBasedPage,
        answers,
        routes.IsTechnicalContactUkBasedController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        TechnicalContactUkAddressPage,
        answers,
        routes.TechnicalContactUkAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        TechnicalContactInternationalAddressPage,
        answers,
        routes.TechnicalContactInternationalAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        AddAnotherTechnicalContactPage,
        answers,
        routes.AddAnotherTechnicalContactController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        SelectOtherTechnicalContactPage,
        answers,
        routes.SelectOtherTechnicalContactController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        WhoIsSecondaryTechnicalContactPage,
        answers,
        routes.WhoIsSecondaryTechnicalContactController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        IsSecondaryTechnicalContactUkBasedPage,
        answers,
        routes.IsSecondaryTechnicalContactUkBasedController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        SecondaryTechnicalContactUkAddressPage,
        answers,
        routes.SecondaryTechnicalContactUkAddressController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
  ...
  protected def iprPageStatuses(answers: UserAnswers): Seq[PageStatus[_]] =
    answers.get(IprDetailsQuery) match {
      case Some(iprs) if iprs.nonEmpty =>
        iprs.zipWithIndex.flatMap { case (_, index) =>
          Seq(
            PageStatus(
              IpRightsTypePage(index),
              answers,
              routes.IpRightsTypeController.onPageLoad(NormalMode, index, answers.id)
            ),
            PageStatus(
              IpRightsSupplementaryProtectionCertificateTypePage(index),
              answers,
              routes.IpRightsSupplementaryProtectionCertificateTypeController.onPageLoad(NormalMode, index, answers.id)
            ),
            PageStatus(
              IpRightsRegistrationNumberPage(index),
              answers,
              routes.IpRightsRegistrationNumberController.onPageLoad(NormalMode, index, answers.id)
            ),
            PageStatus(
              IpRightsRegistrationEndPage(index),
              answers,
              routes.IpRightsRegistrationEndController.onPageLoad(NormalMode, index, answers.id)
            ),
            PageStatus(
              IpRightsDescriptionPage(index),
              answers,
              routes.IpRightsDescriptionController.onPageLoad(NormalMode, index, answers.id)
            ),
            PageStatus(
              IpRightsDescriptionWithBrandPage(index),
              answers,
              routes.IpRightsDescriptionWithBrandController.onPageLoad(NormalMode, index, answers.id)
            ),
            PageStatus(
              IpRightsNiceClassPage(index, 0),
              answers,
              routes.IpRightsNiceClassController.onPageLoad(NormalMode, index, 0, answers.id)
            )
          )
        }
      case _                           =>
        Seq(
          PageStatus(IpRightsTypePage(0), answers, routes.IpRightsTypeController.onPageLoad(NormalMode, 0, answers.id))
        )
    }
  ...
  protected def additionalInformationPageStatuses(answers: UserAnswers): Seq[PageStatus[_]] =
    Seq(
      PageStatus(
        AdditionalInfoProvidedPage,
        answers,
        routes.AdditionalInfoProvidedController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        RestrictedHandlingPage,
        answers,
        routes.RestrictedHandlingController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(
        PermissionToDestroySmallConsignmentsPage,
        answers,
        routes.PermissionToDestroySmallConsignmentsController.onPageLoad(NormalMode, answers.id)
      ),
      PageStatus(IsExOfficioPage, answers, routes.IsExOfficioController.onPageLoad(NormalMode, answers.id)),
      PageStatus(
        WantsOneYearRightsProtectionPage,
        answers,
        routes.WantsOneYearRightsProtectionController.onPageLoad(NormalMode, answers.id)
      )
    )
  ...
  def continue(answers: UserAnswers): Call = {
    ...
    val pageStatuses =
      mainPageStatuses(answers) ++ iprPageStatuses(answers) ++ additionalInformationPageStatuses(answers)
