...
class AfaConnector @Inject()(
  ...
  def submitTestOnlyAfa(afa: String, afaId: String)(implicit ec: ExecutionContext, hc: HeaderCarrier): Future[HttpResponse] =
    httpClient.PUTString[HttpResponse](url(afaId), afa, Seq {
