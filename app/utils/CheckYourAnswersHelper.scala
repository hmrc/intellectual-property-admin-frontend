...
class CheckYourAnswersHelper(userAnswers: UserAnswers)(implicit messages: Messages) {
  ...
  def additionalInfoProvided: Option[AnswerRowWithUrl] = userAnswers.get(AdditionalInfoProvidedPage) map { x =>
  ...
  def restrictedHandling: Option[AnswerRowWithUrl] = userAnswers.get(RestrictedHandlingPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def ipRightsSupplementaryProtectionCertificateType(mode: Mode, index: Int): Option[AnswerRowWithUrl] =
    userAnswers.get(IpRightsSupplementaryProtectionCertificateTypePage(index)) map { x =>
      new AnswerRowWithUrl(
  ...
  def ipRightsBrand(mode: Mode, index: Int): Option[AnswerRowWithUrl] =
    userAnswers.get(IpRightsDescriptionWithBrandPage(index)) map { x =>
      new AnswerRowWithUrl(
  ...
  def ipRightsDescriptionWithBrand(mode: Mode, index: Int): Option[AnswerRowWithUrl] =
    userAnswers.get(IpRightsDescriptionWithBrandPage(index)) map { x =>
      new AnswerRowWithUrl(
  ...
  def ipRightsDescription(mode: Mode, index: Int): Option[AnswerRowWithUrl] =
    userAnswers.get(IpRightsDescriptionPage(index)) map { x =>
      new AnswerRowWithUrl(
  ...
  def representativeEvidenceOfPower: Option[AnswerRow] = userAnswers.get(EvidenceOfPowerToActPage).map { x =>
    new AnswerRowWithUrl(
  ...
  def whoIsTechnicalContactEmail: Option[AnswerRowWithUrl] = userAnswers.get(WhoIsTechnicalContactPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def whoIsTechnicalContactPhone: Option[AnswerRowWithUrl] = userAnswers.get(WhoIsTechnicalContactPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def whoIsTechnicalContactName: Option[AnswerRowWithUrl] = userAnswers.get(WhoIsTechnicalContactPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def whoIsTechnicalContactCompany: Option[AnswerRowWithUrl] = userAnswers.get(WhoIsTechnicalContactPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def whoIsSecondaryTechnicalContactName: Option[AnswerRowWithUrl] =
    userAnswers.get(WhoIsSecondaryTechnicalContactPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def whoIsSecondaryTechnicalContactCompany: Option[AnswerRowWithUrl] =
    userAnswers.get(WhoIsSecondaryTechnicalContactPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def whoIsSecondaryTechnicalContactPhone: Option[AnswerRowWithUrl] =
    userAnswers.get(WhoIsSecondaryTechnicalContactPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def whoIsSecondaryTechnicalContactEmail: Option[AnswerRowWithUrl] =
    userAnswers.get(WhoIsSecondaryTechnicalContactPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def isSecondaryTechnicalContactUkBased: Option[AnswerRowWithUrl] =
    userAnswers.get(IsSecondaryTechnicalContactUkBasedPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def secondaryTechnicalContactUkAddress: Option[AnswerRowWithUrl] =
    userAnswers.get(SecondaryTechnicalContactUkAddressPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def secondaryTechnicalContactInternationalAddress: Option[AnswerRowWithUrl] =
    userAnswers.get(SecondaryTechnicalContactInternationalAddressPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def representativeContactName: Option[AnswerRowWithUrl] = userAnswers.get(RepresentativeDetailsPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def representativeContactCompanyName: Option[AnswerRowWithUrl] = userAnswers.get(RepresentativeDetailsPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def representativeContactRole: Option[AnswerRowWithUrl] = userAnswers.get(RepresentativeDetailsPage) flatMap {
    contact =>
      contact.roleOrPosition map { role =>
        new AnswerRowWithUrl(
  ...
  def representativeContactTelephone: Option[AnswerRowWithUrl] = userAnswers.get(RepresentativeDetailsPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def representativeContactEmail: Option[AnswerRowWithUrl] = userAnswers.get(RepresentativeDetailsPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def isRepresentativeUkBased: Option[AnswerRowWithUrl] = userAnswers.get(IsRepresentativeContactUkBasedPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def representativeContactUkAddress: Option[AnswerRowWithUrl] =
    userAnswers.get(RepresentativeContactUkAddressPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def representativeContactInternationalAddress: Option[AnswerRowWithUrl] =
    userAnswers.get(RepresentativeContactInternationalAddressPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def applicantLegalContactName: Option[AnswerRowWithUrl] = userAnswers.get(ApplicantLegalContactPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def applicantLegalCompanyName: Option[AnswerRowWithUrl] = userAnswers.get(ApplicantLegalContactPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def applicantLegalContactTelephone: Option[AnswerRowWithUrl] = userAnswers.get(ApplicantLegalContactPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def applicantLegalContactOtherTelephone: Option[AnswerRowWithUrl] =
    userAnswers.get(ApplicantLegalContactPage) flatMap { contact =>
      contact.otherTelephone map { phone =>
        new AnswerRowWithUrl(
  ...
  def applicantLegalContactEmail: Option[AnswerRowWithUrl] = userAnswers.get(ApplicantLegalContactPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def isApplicantLegalContactUkBased: Option[AnswerRowWithUrl] =
    userAnswers.get(IsApplicantLegalContactUkBasedPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def applicantSecondaryLegalContactName: Option[AnswerRowWithUrl] =
    userAnswers.get(WhoIsSecondaryLegalContactPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def applicantSecondaryLegalContactCompanyName: Option[AnswerRowWithUrl] =
    userAnswers.get(WhoIsSecondaryLegalContactPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def applicantSecondaryLegalContactTelephone: Option[AnswerRowWithUrl] =
    userAnswers.get(WhoIsSecondaryLegalContactPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def applicantSecondaryLegalContactEmail: Option[AnswerRowWithUrl] =
    userAnswers.get(WhoIsSecondaryLegalContactPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def isApplicantSecondaryLegalContactUkBased: Option[AnswerRowWithUrl] =
    userAnswers.get(IsApplicantSecondaryLegalContactUkBasedPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def applicantSecondaryLegalContactUkAddress: Option[AnswerRowWithUrl] =
    userAnswers.get(ApplicantSecondaryLegalContactUkAddressPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def applicantSecondaryLegalContactInternationalAddress: Option[AnswerRowWithUrl] =
    userAnswers.get(ApplicantSecondaryLegalContactInternationalAddressPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def companyApplyingName: Option[AnswerRowWithUrl] = userAnswers.get(CompanyApplyingPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def companyAcronym: Option[AnswerRowWithUrl] = userAnswers.get(CompanyApplyingPage) flatMap { x =>
    x.acronym map { y =>
      new AnswerRowWithUrl(
  ...
  def isCompanyApplyingUkBased: Option[AnswerRowWithUrl] = userAnswers.get(IsCompanyApplyingUkBasedPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def companyApplyingInternationalAddress: Option[AnswerRowWithUrl] =
    userAnswers.get(CompanyApplyingInternationalAddressPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def ipRightsRegistrationEnd(mode: Mode, index: Int): Option[AnswerRowWithUrl] =
    userAnswers.get(IpRightsRegistrationEndPage(index)) map { x =>
      new AnswerRowWithUrl(
  ...
  def ipRightsRegistrationNumber(mode: Mode, index: Int): Option[AnswerRowWithUrl] =
    userAnswers.get(IpRightsRegistrationNumberPage(index)) map { x =>
      new AnswerRowWithUrl(
  ...
  def permissionToDestroySmallConsignments: Option[AnswerRowWithUrl] =
    userAnswers.get(PermissionToDestroySmallConsignmentsPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def isExOfficio: Option[AnswerRowWithUrl] = userAnswers.get(IsExOfficioPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def technicalContactInternationalAddress: Option[AnswerRowWithUrl] =
    userAnswers.get(TechnicalContactInternationalAddressPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def applicantLegalContactInternationalAddress: Option[AnswerRowWithUrl] =
    userAnswers.get(ApplicantLegalContactInternationalAddressPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def technicalContactUkAddress: Option[AnswerRowWithUrl] = userAnswers.get(TechnicalContactUkAddressPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def applicantLegalContactUkAddress: Option[AnswerRowWithUrl] =
    userAnswers.get(ApplicantLegalContactUkAddressPage) map { x =>
      new AnswerRowWithUrl(
  ...
  def isTechnicalContactUkBased: Option[AnswerRowWithUrl] = userAnswers.get(IsTechnicalContactUkBasedPage) map { x =>
    new AnswerRowWithUrl(
  ...
  def applicationReceiptDate: Option[AnswerRowWithUrl] = userAnswers.get(ApplicationReceiptDatePage) map { x =>
    new AnswerRowWithUrl(
  ...
  def niceClasses(mode: Mode, iprIndex: Int): Option[Seq[AnswerRowWithUrl]] =
    userAnswers.get(NiceClassIdsQuery(iprIndex)).map { niceClasses =>
  ...
  def representativeSection: Option[AnswerSection] =
    representativeContactName.map(_ =>
      AnswerSection(
  ...
  def legalContactSection: Option[AnswerSection] =
    applicantLegalContactName.map(_ =>
      AnswerSection(
  ...
  def technicalContactSection: Option[AnswerSection] =
    whoIsTechnicalContactName.map(_ =>
      AnswerSection(
    ...
    whoIsTechnicalContactName.map(_ =>
      whoIsSecondaryTechnicalContactName.fold(
        ...
        AnswerSection(
          ...
          Some(
            SectionLink(
              controllers.routes.ConfirmRemoveOtherContactController.onPageLoad(afaId, "technical").url,
  ...
  val iprDetails: Option[List[AnswerRow]] = userAnswers.get(IprDetailsQuery) match {
    case a @ Some(iprs) if iprs.nonEmpty =>
      a.map(_.zipWithIndex.map { case (ipr, index) =>
    ...
    iprDetails.map { answerRows =>
      ...
      if (canCreateAfa) {
        AnswerSection(
          ...
          Some(
            SectionLink(
              routes.AddIpRightController.onPageLoad(CheckMode, afaId).url,
              "checkYourAnswers.addIpRight.link"
            )
          )
        )
      } else {
