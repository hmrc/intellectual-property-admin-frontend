...
class SelectTechnicalContactViewSpec extends ViewBehaviours {
  ...
  val radioOptionsMin     =
    Seq((ContactOptions.RepresentativeContact, "representativeContact"), (ContactOptions.LegalContact, "legalContact"))
  val radioOptionsMax     = Seq(
    (ContactOptions.RepresentativeContact, "representativeContact"),
  ...
  "SelectTechnicalContactView" must {
    ...
    "For only a representative and legal contact" should {
      ...
      "have the correct label for the first radio button" in {
        element("#main-content > div > div > form > div.govuk-form-group > fieldset > div > div:nth-child(1) > label")
          .attr("for") mustBe "value-representativeContact"
      }
      ...
      "have the correct label for the second radio button" in {
        element("#main-content > div > div > form > div.govuk-form-group > fieldset > div > div:nth-child(2) > label")
          .attr("for") mustBe "value-legalContact"
      }
      "have the 'or' text before the final radio button" in {
        elementText(
          "#main-content > div > div > form > div.govuk-form-group > fieldset > div > div.govuk-radios__divider"
        ) mustEqual "or"
      }
      ...
      "have the correct label for the someone-else radio button" in {
        element("#main-content > div > div > form > div.govuk-form-group > fieldset > div > div:nth-child(4) > label")
          .attr("for") mustBe "someone-else"
      }
    }
    ...
    "For a representative, legal and otherLegal contact" should {
      ...
      "have the correct label for the third radio button" in {
        element("#main-content > div > div > form > div.govuk-form-group > fieldset > div > div:nth-child(3) > label")
          .attr("for") mustBe "value-secondaryLegalContact"
      }
      "have the 'or' text before the final radio button" in {
        elementText(
          "#main-content > div > div > form > div.govuk-form-group > fieldset > div > div.govuk-radios__divider"
      ...
      "have the correct label for the someone-else radio button" in {
        element("#main-content > div > div > form > div.govuk-form-group > fieldset > div > div:nth-child(5) > label")
          .attr("for") mustBe "someone-else"
      }
    }
