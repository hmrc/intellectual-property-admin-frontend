...
class DeleteIpRightViewSpec extends YesNoViewBehaviours {

  val messageKeyPrefix = "deleteIpRight"

  val form = new DeleteIpRightFormProvider()()

  "DeleteIpRight view" must {
    ...
    def applyView(form: Form[_]): HtmlFormat.Appendable =
      view.apply(form, NormalMode, afaId, 1)(fakeRequest, messages)
    ...
    behave like yesNoPageUsingDesignSystem(
      ...
      applyView,
      messageKeyPrefix,
      routes.DeleteIpRightController.onSubmit(NormalMode, afaId, 1).url
    )
