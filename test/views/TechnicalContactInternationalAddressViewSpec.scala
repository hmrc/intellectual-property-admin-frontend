...
class TechnicalContactInternationalAddressViewSpec extends TextInputViewBehaviours[InternationalAddress] {

  val messageKeyPrefix = "technicalContactInternationalAddress"
  ...
  "TechnicalContactInternationalAddressView" must {
    ...
    val view = injectInstanceOf[TechnicalContactInternationalAddressView](Some(emptyUserAnswers))
    ...
    behave like pageWithTextInputs(
      ...
      applyView,
      messageKeyPrefix,
      routes.TechnicalContactInternationalAddressController.onSubmit(NormalMode, afaId).url,
