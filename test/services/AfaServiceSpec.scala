...
class AfaServiceSpec extends AnyFreeSpec with Matchers with TryValues with MockitoSugar with BeforeAndAfterEach
  ...
  val userAnswersBase: UserAnswers = UserAnswers(userAnswersBaseAfaId)
    ...
    .set(ApplicantLegalContactPage, ApplicantLegalContact("name", "companyName", "phone", None, "email")).success.value
  ...
  "Afa service" - {
    ...
    "for a draft with no IP rights" - {
      ...
      "must not be able to create an afa" in {
        ...
        val Contact(legalContactCompanyName, legalContactName, legalContactPhone, legalContactOtherPhone, legalContactEmail,
        ...
        val userAnswers = {
          ...
          val base = UserAnswers(expectedRequest.id)
            ...
            .set(IsRepresentativeContactLegalContactPage, false).success.value
            .set(ApplicantLegalContactPage, ApplicantLegalContact(legalContactName, legalContactCompanyName, legalContactPhone, legalContactOtherPhone,
    ...
    "for company that is authorised and evidence is not provided" - {
      ...
      val Contact(legalContactCompanyName, legalContactName, legalContactPhone, legalContactOtherPhone,
      legalContactEmail, legalContactAddress: UkAddress) = expectedRequest.legalContact
      ...
      val userAnswers = UserAnswers(expectedRequest.id)
        ...
        .set(EvidenceOfPowerToActPage, evidenceOfPowerToAct).success.value
        .set(IsRepresentativeContactLegalContactPage, false).success.value
        .set(ApplicantLegalContactPage, ApplicantLegalContact(legalContactName, legalContactCompanyName, legalContactPhone, legalContactOtherPhone, legalContactEmail)).success.value
        .set(IsApplicantLegalContactUkBasedPage, true).success.value
        .set(ApplicantLegalContactUkAddressPage, legalContactAddress).success.value
        ...
        .remove(ApplicantSecondaryLegalContactInternationalAddressPage).success.value
    ...
    "for company that is a  collective body" - {
      ...
      val Contact(techContactCompanyName, techContactName, techContactPhone, _, techContactEmail,
      techContactAddress: UkAddress) = expectedRequest.technicalContact
      val RepresentativeContact(contactName, companyName, roleOrPosition, phone, email, address: UkAddress, Some(evidenceOfPowerToAct))
    ...
    "when calling .draftList" - {
      ...
      "must get the list of draft AFAs" in {
        ...
        val secondDraftAfa: UserAnswers = userAnswersBase.copy(id = afaId2)
          .set(CompanyApplyingPage, CompanyApplying("name", None)).success.value
