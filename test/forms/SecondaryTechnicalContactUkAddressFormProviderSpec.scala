...
class SecondaryTechnicalContactUkAddressFormProviderSpec extends StringFieldBehaviours {
  ...
  val line1Key    = "secondaryTechnicalContactUkAddress.line1"
  val line2Key    = "secondaryTechnicalContactUkAddress.line2"
  val postCodeKey = "secondaryTechnicalContactUkAddress.postCode"
