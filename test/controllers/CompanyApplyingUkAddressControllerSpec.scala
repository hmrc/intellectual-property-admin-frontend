...
class CompanyApplyingUkAddressControllerSpec extends SpecBase with MockitoSugar with LockAfaChecks {
  ...
  "Company Applying UK Address Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = baseUserAnswers.set(CompanyApplyingUkAddressPage, validAnswer).success.value
