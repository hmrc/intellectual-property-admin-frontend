...
import models.{AfaId, NormalMode, UkAddress, UserAnswers, WhoIsSecondaryLegalContact}
...
class ApplicantSecondaryLegalContactUkAddressControllerSpec extends SpecBase with MockitoSugar with LockAfaChecks {
