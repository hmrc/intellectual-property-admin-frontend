...
class DeleteNiceClassControllerSpec extends SpecBase with MockitoSugar with LockAfaChecks with IprIndexValidation {
  ...
  lazy val deleteNiceClassRoute: String = routes.DeleteNiceClassController.onPageLoad(NormalMode, afaId, 0, 0).url
  ...
  "DeleteNiceClass Controller" must {
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, NormalMode, afaId, 0, 0)(fakeRequest, messages).toString
    ...
    "for a GET" must {
      ...
      def getForIndex(index: Int): FakeRequest[AnyContentAsEmpty.type] = {
        val route = routes.DeleteNiceClassController.onPageLoad(NormalMode, afaId, index, index).url
    ...
    "for a POST" must {
      ...
      def postForIndex(index: Int): FakeRequest[AnyContentAsFormUrlEncoded] = {
        ...
        val route =
          routes.DeleteNiceClassController.onPageLoad(NormalMode, afaId, index, index).url
