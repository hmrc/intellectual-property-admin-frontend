...
class AdditionalInfoProvidedControllerSpec extends SpecBase with MockitoSugar with LockAfaChecks {
  ...
  "AdditionalInfoProvided Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[AdditionalInfoProvidedView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AdditionalInfoProvidedPage, true).success.value
