...
class IsRepresentativeContactUkBasedControllerSpec extends SpecBase with MockitoSugar with LockAfaChecks {
  ...
  "IsRepresentativeContactUkBased Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = baseUserAnswers.set(IsRepresentativeContactUkBasedPage, true).success.value
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, NormalMode, rightsHolderContact.contactName, afaId)(fakeRequest, messages).toString
