...
class WantsOneYearRightsProtectionControllerSpec extends SpecBase with MockitoSugar with LockAfaChecks {
  ...
  def getRequest(): FakeRequest[AnyContentAsEmpty.type] =
    FakeRequest(GET, wantsOneYearRightsProtectionRoute)

  def postRequest(): FakeRequest[AnyContentAsFormUrlEncoded] =
    FakeRequest(POST, wantsOneYearRightsProtectionRoute)
      .withFormUrlEncodedBody(("value", "true"))

  "WantsOneYearRightsProtection Controller" must {
    ...
    "return OK and the correct view for a GET" in {
      ...
      val view = application.injector.instanceOf[WantsOneYearRightsProtectionView]
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(WantsOneYearRightsProtectionPage, true).success.value
