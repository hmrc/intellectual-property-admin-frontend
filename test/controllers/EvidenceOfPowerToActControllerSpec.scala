...
import models.{AfaId, NormalMode, RepresentativeDetails, UserAnswers}
...
class EvidenceOfPowerToActControllerSpec extends SpecBase with MockitoSugar with LockAfaChecks {
  ...
  lazy val evidenceOfPowerToActRoute: String = routes.EvidenceOfPowerToActController.onPageLoad(NormalMode, afaId).url
  ...
  "EvidenceOfPowerToAct Controller" must {
    ...
    "populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = baseUserAnswers.set(EvidenceOfPowerToActPage, true).success.value
      ...
      contentAsString(result) mustEqual
        view(form.fill(true), NormalMode, afaId, rightsHolderContact.contactName)(fakeRequest, messages).toString
    ...
    "return a Bad Request and errors when invalid data is submitted" in {
      ...
      contentAsString(result) mustEqual
        view(boundForm, NormalMode, afaId, rightsHolderContact.contactName)(fakeRequest, messages).toString
