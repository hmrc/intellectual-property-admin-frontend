  ...
  "PlantVariety" - {
    ...
    "must deserialise" in {
      ...
      forAll(arbitrary[String]) { description =>
        ...
        json.validate[PlantVariety] shouldBe JsSuccess(PlantVariety(description))
      }
    }
    ...
    "must fail to deserialise for a rightsType other than plantVariety" in {
      ...
      forAll(arbitrary[String], Gen.alphaStr) { (description, rightsType) =>
        whenever(rightsType != "plantVariety") {
          ...
          json.validate[PlantVariety] shouldBe JsError(
    ...
    "must serialise" in {
      ...
      forAll(arbitrary[String]) { description =>
        ...
        Json.toJson(PlantVariety(description))(PlantVariety.writes) shouldBe json
      }
    }
  }
}
