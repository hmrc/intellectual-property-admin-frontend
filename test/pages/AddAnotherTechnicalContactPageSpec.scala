...
class AddAnotherTechnicalContactPageSpec extends PageBehaviours {
  ...
  "remove all secondary technical contact data when the answer is no" in {
    ...
    forAll(arbitrary[UserAnswers], arbitrary[TechnicalContact], arbitrary[Boolean],
      ...
      (userAnswers, secondaryLegalContact, ukBased, ukAddress, internationalAddress) =>
        ...
        val answers =
          userAnswers
            .set(WhoIsSecondaryTechnicalContactPage, secondaryLegalContact).success.value
            .set(IsSecondaryTechnicalContactUkBasedPage, ukBased).success.value
            .set(SecondaryTechnicalContactUkAddressPage, ukAddress).success.value
            .set(SecondaryTechnicalContactInternationalAddressPage, internationalAddress).success.value
