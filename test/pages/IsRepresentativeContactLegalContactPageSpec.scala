...
class IsRepresentativeContactLegalContactPageSpec extends PageBehaviours {
  ...
  val representativeContact: RepresentativeDetails  =
    RepresentativeDetails(representativeContactName, "companyName", "01234567890", "email", Some("roleOrPosition"))
  val ukRepAddress: UkAddress                       = UkAddress("Grange Central", None, "Telford", None, "TF34ER")
  val internationalRepAddress: InternationalAddress =
    InternationalAddress("Rue Florent", None, "Marseille", "France", None)
  ...
  "IsRepresentativeContactLegalContactPageSpec" must {
    ...
    "be settable and gettable with prerequisites" in {
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        val answers = userAnswers
          ...
          .success
          .value
          .set(RepresentativeContactUkAddressPage, ukRepAddress)
          .success
          .value
    ...
    "replace all legal contact data with representative data when the answer is yes and address is UK based" in {
      ...
      forAll(
        ...
        arbitrary[ApplicantLegalContact],
        arbitrary[Boolean],
        arbitrary[UkAddress],
        ...
        val answers =
          userAnswers
            ...
            .success
            .value
            .set(IsApplicantLegalContactUkBasedPage, ukBased)
            .success
            .value
            .set(ApplicantLegalContactUkAddressPage, ukAddress)
            .success
            .value
            .set(ApplicantLegalContactInternationalAddressPage, internationalAddress)
            .success
            .value
            .set(RepresentativeDetailsPage, representativeContact)
            .success
      ...
      forAll(
        ...
        val answers =
          userAnswers
            ...
            .success
            .value
            .set(RepresentativeContactInternationalAddressPage, internationalRepAddress)
            .success
            .value
